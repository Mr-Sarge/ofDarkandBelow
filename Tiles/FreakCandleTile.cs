...
{
    public class FreakCandleTile : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 48, mod.ItemType("FreakCandleItem"));
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            var flameTexture = mod.GetTexture("Tiles/FreakCandleTile_flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
