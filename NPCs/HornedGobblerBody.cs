...
{    
    public class HornedGobblerBody : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Horned Gobbler");
        }
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/HornedGobblerBodyGore"), 1f);
            }
        }
