...
{
    public class CosmicDiggerHead: ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.damage = 10;    //this is the npc damage
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/CosmicDiggerHeadGore"), 1f);
            }
        }
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                ...
                if (npc.ai[0] == 0)
                {
                    ...
                    int randomWormLength = Main.rand.Next(3, 6);
                    for (int i = 0; i < randomWormLength; ++i)
                    {
                        ...
                        latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("CosmicDiggerBody"), npc.whoAmI, 0, latestNPC);
                        Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                        Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
                    }
                    // When we're out of that loop, we want to 'close' the worm with a tail part!
                    latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y, mod.NPCType("CosmicDiggerTail"), npc.whoAmI, 0, latestNPC);
                    Main.npc[(int)latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int)latestNPC].ai[3] = npc.whoAmI;
		...
		public override void ModifyHitPlayer(Player target, ref int damage, ref bool crit)
        {
            ...
            {
                target.AddBuff(mod.BuffType("CosmicFlame"), 120);
        }
    }
}}
