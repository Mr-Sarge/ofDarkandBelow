...
{
	public class KingBeam : ModProjectile
	{
		...
		public override void AI() {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 17);   //this adds a vanilla terraria dust to the projectile
