...
{
	public class MushSpawn : ModProjectile
	{
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("MushGroundSpike"), 60, 6, projectile.owner, rot);
            return true;
        }
    }
}