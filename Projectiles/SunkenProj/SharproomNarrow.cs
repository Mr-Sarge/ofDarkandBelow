...
{
	public class SharproomNarrow : ModProjectile
	{
		...
		public override void Kill(int timeLeft) {
            Main.PlaySound(SoundLoader.customSoundType, (int)projectile.position.X, (int)projectile.position.Y, mod.GetSoundSlot(SoundType.Custom, "Sounds/Bosses/OldTerraSpikeDet"));
