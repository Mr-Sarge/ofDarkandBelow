...
namespace ofDarkandBelow.Projectiles
{
    public class NullBolt : ModProjectile
    {
        ...
        {
            int DustID2 = Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType("NullDust"), projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, default(Color), 1.5f);
			...
			for (int i = 0; i < 20; i++) {
				Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType("NullDust"), projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, default(Color), 1.5f);
			}
	    }
    }
}